      ...
      <style>
        {`
          :root {
            ...
            --color-1: var(--color-pearl, #F2F0F1);
            --color-2: #ffffff;
            --color-3: var(--color-mist, #D9D8D9);
            --color-4: var(--color-taupe, #BDB6B3);
          }
          .effect {
            position: absolute;
            opacity: 0;
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-1.5 px-4 inline-block font-mono text-xs tracking-[0.2em] uppercase select-none"
                >
                  {item.label}
                </a>
              </li>
